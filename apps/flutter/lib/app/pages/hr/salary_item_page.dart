...
class _SalaryItemPageState extends State<SalaryItemPage> {
  ...
  Future<void> _load() async {
    ...
    try {
      final res = await ApiService.instance.get('/admin/hr/salary-item');
  ...
  Future<void> _create() async {
    await FormDialog.show(context, title: '新增薪资项', fields: _formFields(), onSubmit: (data) async {
      await ApiService.instance.post('/admin/hr/salary-item', data: data);
      _load(); return true;
    });
  }
  ...
  Future<void> _edit(Map<String, dynamic> row) async {
    await FormDialog.show(context, title: '编辑薪资项', fields: _formFields(), initialData: row, onSubmit: (data) async {
      await ApiService.instance.put('/admin/hr/salary-item/${row['id']}', data: data);
      _load(); return true;
    });
  }
  ...
  Future<void> _delete(Map<String, dynamic> row) async {
    await ConfirmDialog.show(context, title: '确认删除', content: '确定要删除「${row['name'] ?? ''}」吗？', onConfirm: (password) async {
      await ApiService.instance.delete('/admin/hr/salary-item/${row['id']}', data: {'password': password});
      _load(); return true;
    });
  }
