...
class _OqcListPageState extends State<OqcListPage> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final res = await ApiService.instance.get('/admin/v1/quality/oqc', params: params);
      final d = res['data'];
  ...
  Future<void> _delete(Map<String, dynamic> row) async {
    await ConfirmDialog.show(context, title: '确认删除', content: '确定要删除「${row['code'] ?? ''}」吗？', onConfirm: (password) async {
      await ApiService.instance.delete('/admin/v1/quality/oqc/${row['id']}', data: {'password': password});
      _load(); return true;
    });
  }
