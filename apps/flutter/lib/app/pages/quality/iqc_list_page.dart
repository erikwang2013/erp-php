...
class _IqcListPageState extends State<IqcListPage> {
  ...
  List<FormFieldConfig> _formFields() {
    ...
    return [
      ...
      FormFieldConfig(name: 'receiving_id', label: l10n.fieldReceivingId, type: FormFieldType.number),
  ...
  List<String> _columns() {
    final l10n = AppL10n.current;
    return [l10n.fieldInspectNo, l10n.fieldProductId, l10n.qualityQtySummary, l10n.fieldResult, l10n.fieldInspector, l10n.commonAction];
  }
