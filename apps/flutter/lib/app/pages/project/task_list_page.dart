...
class _ProjectTaskListPageState extends State<ProjectTaskListPage> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final res = await ApiService.instance.get('/admin/v1/project/task', params: params);
      final d = res['data'];
  ...
  Widget build(BuildContext context) => DataTableWrapper(
    ...
    pageTitle: AppL10n.current.projectTaskTitle,
    moduleKey: 'project',
  ...
  List<String> _columns() {
    final l10n = AppL10n.current;
    return [l10n.commonName, l10n.fieldProject, l10n.commonAction];
  }
