...
class _MrpPageState extends State<MrpPage> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final res = await ApiService.instance.get('/admin/v1/mfg/mrp', params: params);
      final d = res['data'];
  ...
  Future<void> _create() async {
    ...
    await FormDialog.show(context, title: l10n.commonAdd, fields: _formFields(), onSubmit: (data) async {
      await ApiService.instance.post('/admin/v1/mfg/mrp', data: data);
      _load(); return true;
    });
  }
  ...
  Future<void> _edit(Map<String, dynamic> row) async {
    ...
    await FormDialog.show(context, title: l10n.commonEdit, fields: _formFields(), initialData: row, onSubmit: (data) async {
      await ApiService.instance.put('/admin/v1/mfg/mrp/${row['id']}', data: data);
      _load(); return true;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return DataTableWrapper(
      ...
      pageTitle: AppL10n.current.mfgMrpTitle,
      moduleKey: 'mfg',
