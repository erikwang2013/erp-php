...
class _OpportunityListPageState extends State<OpportunityListPage> {
  ...
  Future<void> _create() async {
    ...
    await FormDialog.show(context, title: l10n.commonAdd, fields: _formFields(), onSubmit: (data) async {
      await ApiService.instance.post('/admin/v1/crm/opportunity', data: data);
      _load(); return true;
    });
  }
  ...
  Future<void> _edit(Map<String, dynamic> row) async {
    ...
    await FormDialog.show(context, title: l10n.commonEdit, fields: _formFields(), initialData: row, onSubmit: (data) async {
      await ApiService.instance.put('/admin/v1/crm/opportunity/${row['id']}', data: data);
      _load(); return true;
    });
  }
  ...
  List<FormFieldConfig> _formFields() => [
    ...
    FormFieldConfig(name: 'amount', label: AppL10n.current.crmAmount, type: FormFieldType.number),
    FormFieldConfig(name: 'stage', label: AppL10n.current.crmOpportunityStage),
  ];
  ...
  Map<String, dynamic> _rowToMap(Map<String, dynamic> r) => {
    ...
    AppL10n.current.crmAmount: r['amount'] ?? '',
    AppL10n.current.crmOpportunityStage: r['stage'] ?? '',
