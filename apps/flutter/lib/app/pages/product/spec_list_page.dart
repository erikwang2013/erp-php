...
class SpecListPage extends StatefulWidget {
  ...
  @override
  State<SpecListPage> createState() => _SpecListPageState();
}
...
class _SpecListPageState extends State<SpecListPage> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final res = await ApiService.instance.get('/admin/v1/spec', params: params);
      final d = res['data'];
  ...
  Future<void> _create() async {
    ...
    await FormDialog.show(context, title: l10n.commonAdd, fields: _formFields(), onSubmit: (data) async {
      await ApiService.instance.post('/admin/v1/spec', data: data);
      _load(); return true;
    });
  }
  ...
  Future<void> _edit(Map<String, dynamic> row) async {
    ...
    await FormDialog.show(context, title: l10n.commonEdit, fields: _formFields(), initialData: row, onSubmit: (data) async {
      await ApiService.instance.put('/admin/v1/spec/${row['id']}', data: data);
      _load(); return true;
    });
  }
  ...
  Future<void> _delete(Map<String, dynamic> row) async {
    ...
    await ConfirmDialog.show(context, title: l10n.commonDeleteConfirm, content: l10n.commonDeleteContent(row['name'] ?? '${row['id']}'), onConfirm: (password) async {
      await ApiService.instance.delete('/admin/v1/spec/${row['id']}', data: {'password': password});
      _load(); return true;
    });
  }
  ...
  List<FormFieldConfig> _formFields() {
    ...
    return [
      ...
      FormFieldConfig(name: 'sort', label: l10n.fieldSort, type: FormFieldType.number),
      FormFieldConfig(
        name: 'status',
  ...
  Widget build(BuildContext context) => DataTableWrapper(
    ...
    pageTitle: AppL10n.current.productSpecTitle,
    moduleKey: 'product',
  ...
  List<String> _columns() {
    final l10n = AppL10n.current;
    return [l10n.commonName, l10n.fieldSort, l10n.commonStatus, l10n.commonAction];
  }
  ...
  Map<String, dynamic> _rowToMap(Map<String, dynamic> r) {
    ...
    return {
      ...
      l10n.commonStatus: _statusBadge(r['status']),
  ...
  Widget _statusBadge(dynamic status) {
    ...
    return StatusBadge(
      label: on ? l10n.commonEnabled : l10n.commonDisabled,
      bg: on ? c.successBg : c.dangerBg,
      fg: on ? c.successText : c.dangerText,
    );
  }
}
