...
class _ProductListPageState extends State<ProductListPage> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final res = await ApiService.instance.get('/admin/v1/product', params: params);
      final d = res['data'];
  ...
  Future<void> _delete(Map<String, dynamic> row) async {
    ...
    await ConfirmDialog.show(context, title: l10n.commonDeleteConfirm, content: l10n.commonDeleteContent(row['name'] ?? row['code'] ?? '${row['id']}'), onConfirm: (password) async {
      await ApiService.instance.delete('/admin/v1/product/${row['id']}', data: {'password': password});
      _load(); return true;
    });
  }
  ...
  Widget build(BuildContext context) => DataTableWrapper(
    ...
    pageTitle: AppL10n.current.productListTitle,
    moduleKey: 'product',
  ...
  List<String> _columns() {
    final l10n = AppL10n.current;
    return [l10n.fieldProductName, l10n.fieldCode, l10n.fieldSpec, l10n.fieldPrice, l10n.commonAction];
  }

  Map<String, dynamic> _rowToMap(Map<String, dynamic> r) {
    final l10n = AppL10n.current;
    return {
      l10n.fieldProductName: r['name'] ?? '',
      l10n.fieldCode: r['code'] ?? '',
      l10n.fieldSpec: r['spec'] ?? '',
      l10n.fieldPrice: r['price'] ?? '',
