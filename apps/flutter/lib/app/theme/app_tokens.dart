...
abstract final class AppColors {
  static const light = AppPalette(
    ...
    primaryPressed: Color(0xFF0958D9),
    primaryDisabled: Color(0xFF99BBFF),
    primaryBg: Color(0xFFE6F0FF),
    success: Color(0xFF52C41A),
    successText: Color(0xFF389E0D),
    successBg: Color(0xFFE6FFF0),
    warning: Color(0xFFFA8C16),
    warningText: Color(0xFFD46B08),
    warningBg: Color(0xFFFFFBE6),
    danger: Color(0xFFFF4D4F),
    dangerText: Color(0xFFCF1322),
    dangerBg: Color(0xFFFFE6E6),
    textPrimary: Color(0xFF333333),
    textSecondary: Color(0xFF666666),
    textHint: Color(0xFF999999),
    textDisabled: Color(0xFFCCCCCC),
    textOnPrimary: Color(0xFFFFFFFF),
    bgPage: Color(0xFFF5F5F5),
  ...
  static const dark = AppPalette(
    primary: Color(0xFF1677FF),
    primaryPressed: Color(0xFF4096FF),
    primaryDisabled: Color(0xFF31619B),
    primaryBg: Color(0xFF1E2A3A),
    success: Color(0xFF52C41A),
  ...
  /// 品牌渐变(视觉 2.0 门面专用:登录 hero/移动端品牌带;两主题一致,深底白字)。
  static const brandGradient = LinearGradient(
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
    colors: [Color(0xFF001D66), Color(0xFF1677FF), Color(0xFF69B1FF)],
  );
}
...
/// 圆角分级(视觉 2.0):门面大卡 r16 > 数据卡 r12 > 控件 r6。
