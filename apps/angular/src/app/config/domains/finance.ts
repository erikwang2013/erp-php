...
const f = (title: string, endpoint: string, opts: Partial<import('../types').ResourceConfig> = {}) =>
...
export const financeMenus: MenuGroup[] = [
  {
    ...
    children: [
      ...
      { label: '成本中心', path: '/finance/cost-center', cfg: f('成本中心', '/admin/v1/finance/cost-center', { columns: [textCol('code', '编号', true), { ...textCol('name', '名称', true), indent: true }, textCol('manager', '负责人'), statusCol()], fields: [{ key: 'code', label: '编码', required: true }, { key: 'name', label: '名称', required: true }] }) },
      { label: '利润中心', path: '/finance/profit-center', cfg: f('利润中心', '/admin/v1/finance/profit-center', { columns: [textCol('code', '编号', true), { ...textCol('name', '名称', true), indent: true }, textCol('manager', '负责人'), statusCol()], fields: [{ key: 'code', label: '编码', required: true }, { key: 'name', label: '名称', required: true }] }) },
