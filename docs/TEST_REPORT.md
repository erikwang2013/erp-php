...
> 更新：2026-08-29 — doc-stats 现口径 500 tests / 2171 assertions / 51 skipped（CI docs 作业无 DB 服务、13 个模块测试静默跳过时的实测值，与 docs/FUNCTIONS.md 附录一致）；本报告 513/2368/32 为 2026-08-27 快照口径，已落后，统计以 FUNCTIONS.md 附录为准。
>
