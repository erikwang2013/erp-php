...
> ## 状态：✅ 全部完成（2026-09-05 · v1.4.0）
>
> P0（F1/F2/F3）、P1（M1+M2/F7/M3/M6/B3/B1/H1+H2/E1+P1）、P2（F6/F5/C1/B5/B4+B7/H3+H4）
> 全项交付并关闸：phpunit 916+ 用例全绿、phpstan 0 错误、install.sql 基线并入全部新表。
> 功能清单见 README 与 docs/FUNCTIONS.md §19 完成度矩阵（2026-09-05 校正）。
