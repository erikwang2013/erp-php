# Renforcement du backend — plan d'implémentation
...
### Task 1: Ajout des traits SoftDeletes + Searchable au modèle AdminUser

**Files:**
- Modify: `app/model/AdminUser.php`

- [ ] **Step 1: Modifier le modèle AdminUser**

Insérer deux importations `use` après la ligne 10 de `app/model/AdminUser.php`, et utiliser les deux traits au début du corps de la classe :
...
Ajouter également la méthode `toSearchableArray()` à la fin de la classe (après la méthode `roles()`, avant l'accolade fermante de la classe) :
...
- [ ] **Step 1: Créer le middleware Cors**
...
### Task 3: Middleware de limitation de débit RateLimit

**Files:**
- Create: `app/middleware/RateLimit.php`

- [ ] **Step 1: Créer le middleware RateLimit**
...
### Task 4: Middleware de journalisation des opérations OperationLog

**Files:**
- Create: `app/middleware/OperationLog.php`

- [ ] **Step 1: Créer le middleware OperationLog**
...
### Task 5: Configuration des middlewares globaux

**Files:**
- Modify: `config/middleware.php`

- [ ] **Step 1: Enregistrer les middlewares globaux**
...
### Task 6: Contrôleur de health check

**Files:**
- Create: `app/admin/controller/HealthController.php`

- [ ] **Step 1: Créer HealthController**
...
### Task 7: Contrôleur CRUD de configuration système

**Files:**
- Create: `app/admin/controller/ConfigController.php`

- [ ] **Step 1: Créer ConfigController**
...
### Task 8: Contrôleur de consultation des journaux d'opérations

**Files:**
- Create: `app/admin/controller/LogController.php`

- [ ] **Step 1: Créer LogController**
...
### Task 9: Contrôleur d'espace personnel (avec déconnexion)

**Files:**
- Create: `app/admin/controller/ProfileController.php`
- Modify: `app/middleware/AdminAuth.php` (vérification de la liste noire JWT)

- [ ] **Step 1: Modifier le middleware AdminAuth, ajouter la vérification de la liste noire JWT**

Dans la méthode `AdminAuth::process()`, insérer le contrôle de liste noire après l'extraction du jeton et avant le décodage JWT :
...
Il faut également ajouter l'importation Redis. Modifier l'en-tête du fichier :
...
- [ ] **Step 2: Créer ProfileController**
...
### Task 10: Contrôleur d'upload de fichiers
...
### Task 11: Opérations en masse sur les utilisateurs

**Files:**
- Modify: `app/admin/controller/UserController.php`

- [ ] **Step 1: Ajouter deux méthodes à la fin de la classe UserController (après la méthode `destroy`)**
...
### Task 12: Contrôleur d'import Excel

**Files:**
- Create: `app/admin/controller/ImportController.php`

- [ ] **Step 1: Créer ImportController**
...
### Task 13: Mise à jour des routes — toutes les nouvelles routes + liaison des middlewares

**Files:**
- Modify: `config/route.php`

- [ ] **Step 1: Mettre à jour la configuration des routes**
