...
| Ligne de base qualité | PHPUnit 1046<!-- stats:tests=1046 --> tests / 5029<!-- stats:assertions=5029 --> assertions, PHPStan + baseline, CS-Fixer, matrice multi-versions CI | La discipline existe déjà ; les rôles de test / revue sont directement intégrés au pipeline |
...
```
phpunit            # 1046<!-- stats:tests=1046 --> tests / 5029<!-- stats:assertions=5029 --> assertions au vert, les nouveaux cas sont livrés avec la modification
