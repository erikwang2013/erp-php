...
| Ligne de base qualité | PHPUnit 1044<!-- stats:tests=1044 --> tests / 5020<!-- stats:assertions=5020 --> assertions, PHPStan + baseline, CS-Fixer, matrice multi-versions CI | La discipline existe déjà ; les rôles de test / revue sont directement intégrés au pipeline |
...
```
phpunit            # 1044<!-- stats:tests=1044 --> tests / 5020<!-- stats:assertions=5020 --> assertions au vert, les nouveaux cas sont livrés avec la modification
