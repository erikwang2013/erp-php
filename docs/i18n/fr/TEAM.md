...
| Ligne de base qualité | PHPUnit 1048<!-- stats:tests=1048 --> tests / 5040<!-- stats:assertions=5040 --> assertions, PHPStan + baseline, CS-Fixer, matrice multi-versions CI | La discipline existe déjà ; les rôles de test / revue sont directement intégrés au pipeline |
...
```
phpunit            # 1048<!-- stats:tests=1048 --> tests / 5040<!-- stats:assertions=5040 --> assertions au vert, les nouveaux cas sont livrés avec la modification
