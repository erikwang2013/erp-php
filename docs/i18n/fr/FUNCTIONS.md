...
| Tests unitaires | 113<!-- stats:test_files=113 --> fichiers de test  / 1051<!-- stats:tests=1051 --> cas de test  / 5047<!-- stats:assertions=5047 --> assertions  (décompte statique : méthodes de test + points d'appel d'assertion, indépendant de l'environnement d'exécution) |
