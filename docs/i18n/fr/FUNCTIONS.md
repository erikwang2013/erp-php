...
| Tests unitaires | 113 fichiers de test <!-- stats:test_files=113 --> / 1037 cas de test <!-- stats:tests=1037 --> / 4962 assertions <!-- stats:assertions=4962 --> (décompte statique : méthodes de test + points d'appel d'assertion, indépendant de l'environnement d'exécution) |
