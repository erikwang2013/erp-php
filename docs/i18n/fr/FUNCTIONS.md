...
| Tests unitaires | 113<!-- stats:test_files=113 --> fichiers de test  / 1055<!-- stats:tests=1055 --> cas de test  / 5056<!-- stats:assertions=5056 --> assertions  (décompte statique : méthodes de test + points d'appel d'assertion, indépendant de l'environnement d'exécution) |
