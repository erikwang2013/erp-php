...
| Tests unitaires | 113<!-- stats:test_files=113 --> fichiers de test  / 1048<!-- stats:tests=1048 --> cas de test  / 5040<!-- stats:assertions=5040 --> assertions  (décompte statique : méthodes de test + points d'appel d'assertion, indépendant de l'environnement d'exécution) |
