# P0 Панель управления Flutter Web — план реализации
...
### Задача 1: Конфигурация меню и рефакторинг маршрутов

**Файлы:**
- Создать: `apps/flutter/lib/app/config/menu_config.dart`
- Изменить: `apps/flutter/lib/app/layouts/admin_layout.dart` (полная переработка)
- Изменить: `apps/flutter/lib/main.dart` (регистрация маршрутов)
- Перенести: существующие файлы страниц в новую структуру каталогов

- [ ] **Шаг 1: Создание menu_config.dart**
...
- [ ] **Шаг 2: Переработка AdminLayout для динамического рендеринга меню**
...
- [ ] **Шаг 3: Обновление main.dart — централизованная регистрация маршрутов**
...
- [ ] **Шаг 4: Перенос файлов существующих страниц**
...
- [ ] **Шаг 5: Проверка компиляции** — Run: `cd apps/flutter && flutter analyze`

- [ ] **Шаг 6: Коммит**

---

### Задача 2: Универсальный компонент — DataTableWrapper

**Файлы:** Создать: `apps/flutter/lib/app/widgets/data_table_wrapper.dart`
...
### Задача 3: Универсальные компоненты — FormDialog + ConfirmDialog + StatCard

**Файлы:**
- Создать: `apps/flutter/lib/app/widgets/form_dialog.dart`
- Создать: `apps/flutter/lib/app/widgets/confirm_dialog.dart`
- Создать: `apps/flutter/lib/app/widgets/stat_card.dart`

- [ ] **Шаг 1: Создание FormDialog**
...
### Задача 4-20: Пакетное создание страниц модулей

> Каждая задача покрывает один модуль, все страницы списков следуют единому шаблону CRUD.

**Стандартный шаблон CRUD-страницы списка** (каждая страница ~70 строк):
...
**Контрольный список создания страниц**:

| Задача | Модуль | Каталог | Страниц |
|------|------|------|--------|
| 4 | Товары | `pages/product/` | 4 |
| 5 | Контрагенты | `pages/partner/` | 4 |
| 6 | Закупки | `pages/purchase/` | 4 |
| 7 | Продажи | `pages/sales/` | 4 |
| 8 | Склад | `pages/inventory/` | 5 |
| 9 | Финансы 1 (документы/дебиторка-кредиторка/поступления-платежи/журнал/расходы) | `pages/finance/` | 6 |
| 10 | Финансы 2 (главная книга/отчёты/активы/налоги/валюты/бюджет/затраты) | `pages/finance/` | 7 |
| 11 | CRM | `pages/crm/` | 8 |
| 12 | OMS | `pages/oms/` | 4 |
| 13 | WMS | `pages/wms/` | 7 |
| 14 | TMS | `pages/tms/` | 5 |
| 15 | Производство | `pages/manufacturing/` | 5 |
| 16 | HR | `pages/hr/` | 6 |
| 17 | Проекты | `pages/project/` | 3 |
| 18 | Workflow согласования | `pages/workflow/` | 2 |
| 19 | Уведомления | `pages/notification/` | 1 |
| 20 | Пользовательские отчёты | `pages/report/` | 2 |

После каждой задачи: обновить `main.dart`, добавив соответствующие маршруты + проверка `flutter analyze`.

---

### Задача 21: Расширение Dashboard

**Файлы:**
- Изменить: `apps/flutter/lib/app/pages/dashboard/dashboard_page.dart`
- Изменить: `apps/flutter/lib/app/pages/dashboard/dashboard_controller.dart`

- [ ] **Шаг 1: Добавление панелей OMS/WMS/TMS к существующим 4 вкладкам**

В TabBar добавить: `const Tab(text: 'OMS')`, `const Tab(text: 'WMS')`, `const Tab(text: 'TMS')`
В TabBarView добавить соответствующие методы `_omsTab()`, `_wmsTab()`, `_tmsTab()`, каждый с 3-4 StatCard.

- [ ] **Шаг 2: Коммит**

---

### Задача 22: Регистрация всех маршрутов + финальная проверка

- [ ] **Шаг 1: Дополнить регистрацию всех GetPage в main.dart**
- [ ] **Шаг 2: `flutter analyze` → No issues found**
- [ ] **Шаг 3: `flutter run -d chrome` — ручная приёмка меню и страниц всех 14 модулей**
- [ ] **Шаг 4: Коммит**

---

### Задача 23: Выравнивание с HarmonyOS

**Файлы:** создать новые страницы в `apps/harmonyos/entry/src/main/ets/pages/`

- [ ] Создать страницы ArkTS для 8 модулей: OMS/WMS/TMS/производство/HR/согласование/уведомления/отчёты
- [ ] Обновить `main_pages.json` — регистрация маршрутов
- [ ] Проверить компиляцию

---

**Критерии приёмки (P0 complete):**
- [ ] Все 14 модулей в боковой панели Flutter Web доступны для навигации
- [ ] Все CRUD-страницы списков корректно загружаются, работают пагинация и поиск
- [ ] Диалоги создания/редактирования + подтверждение удаления паролем работают
- [ ] Адаптивная вёрстка PC/планшет/телефон корректна
- [ ] Автоматическое обновление при истечении JWT
- [ ] Количество страниц HarmonyOS ≥ 80% от страниц Flutter
