...
| 품질 베이스라인 | PHPUnit 1051<!-- stats:tests=1051 --> 테스트 / 5047<!-- stats:assertions=5047 --> 어서션, PHPStan + baseline, CS-Fixer, CI 다중 버전 매트릭스 | 이미 규율 확보, 테스트/리뷰 역할이 파이프라인에 직접 내장 |
...
```
phpunit            # 1051<!-- stats:tests=1051 --> 테스트 / 5047<!-- stats:assertions=5047 --> 어서션 전부 통과, 신규 케이스는 변경과 함께 커밋
