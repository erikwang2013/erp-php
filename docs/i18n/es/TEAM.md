...
| Línea base de calidad | PHPUnit 1048<!-- stats:tests=1048 --> tests / 5040<!-- stats:assertions=5040 --> assertions, PHPStan + baseline, CS-Fixer, matriz multiversión del CI | Ya hay disciplina; los roles de prueba/revisión se integran directamente en el pipeline |
...
```
phpunit            # 1048<!-- stats:tests=1048 --> tests / 5040<!-- stats:assertions=5040 --> assertions todo en verde; los casos nuevos se envían con el cambio
