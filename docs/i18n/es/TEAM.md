...
| Línea base de calidad | PHPUnit 1044<!-- stats:tests=1044 --> tests / 5020<!-- stats:assertions=5020 --> assertions, PHPStan + baseline, CS-Fixer, matriz multiversión del CI | Ya hay disciplina; los roles de prueba/revisión se integran directamente en el pipeline |
...
```
phpunit            # 1044<!-- stats:tests=1044 --> tests / 5020<!-- stats:assertions=5020 --> assertions todo en verde; los casos nuevos se envían con el cambio
