...
| Línea base de calidad | PHPUnit 1046<!-- stats:tests=1046 --> tests / 5029<!-- stats:assertions=5029 --> assertions, PHPStan + baseline, CS-Fixer, matriz multiversión del CI | Ya hay disciplina; los roles de prueba/revisión se integran directamente en el pipeline |
...
```
phpunit            # 1046<!-- stats:tests=1046 --> tests / 5029<!-- stats:assertions=5029 --> assertions todo en verde; los casos nuevos se envían con el cambio
