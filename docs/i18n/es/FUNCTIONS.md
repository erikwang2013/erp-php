...
| Pruebas unitarias | 111 archivos de prueba <!-- stats:test_files=113 --> / 1001 casos de prueba <!-- stats:tests=1037 --> / 4726 aserciones <!-- stats:assertions=4962 --> (recuento estático: número de métodos de prueba + puntos de llamada a aserciones, independiente del entorno de ejecución) |
