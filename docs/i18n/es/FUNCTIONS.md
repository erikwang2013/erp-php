...
| Pruebas unitarias | 50 archivos de prueba <!-- stats:test_files=110 --> / 442 casos de prueba / 2238 aserciones (tests/assertions varían con la versión de parche de PHP y las extensiones; no participan en la verificación exacta de stats) |
