...
| Pruebas unitarias | 113<!-- stats:test_files=113 --> archivos de prueba  / 1051<!-- stats:tests=1051 --> casos de prueba  / 5047<!-- stats:assertions=5047 --> aserciones  (recuento estático: número de métodos de prueba + puntos de llamada a aserciones, independiente del entorno de ejecución) |
