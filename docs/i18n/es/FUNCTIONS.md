...
| Pruebas unitarias | 113<!-- stats:test_files=113 --> archivos de prueba  / 1055<!-- stats:tests=1055 --> casos de prueba  / 5056<!-- stats:assertions=5056 --> aserciones  (recuento estático: número de métodos de prueba + puntos de llamada a aserciones, independiente del entorno de ejecución) |
