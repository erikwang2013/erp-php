# P0 Panel de administración web Flutter — plan de implementación

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Ampliar el panel de administración web Flutter de las ~12 páginas existentes a 40+ páginas que cubran los 14 módulos completos del backend, creando una biblioteca de componentes comunes reutilizables.

**Architecture:** Refactorizar hacia un sistema de menús dinámico basado en configuración (`menu_config.dart`), con diseño de PC de tres columnas (barra lateral plegable + barra superior + área de contenido) y componentes CRUD comunes (DataTableWrapper/FormDialog/ConfirmDialog) reutilizables en las páginas de cada módulo.
...
### Task 1: Configuración de menús y refactorización de rutas

**Files:**
- Create: `apps/flutter/lib/app/config/menu_config.dart`
- Modify: `apps/flutter/lib/app/layouts/admin_layout.dart` (reescritura completa)
- Modify: `apps/flutter/lib/main.dart` (registro de rutas)
- Move: migrar los archivos de páginas existentes a la nueva estructura de directorios

- [ ] **Step 1: Crear menu_config.dart**
...
- [ ] **Step 2: Reescribir AdminLayout para el renderizado dinámico de menús**
...
- [ ] **Step 3: Actualizar main.dart con el registro centralizado de rutas**
...
- [ ] **Step 4: Migrar los directorios de archivos de páginas existentes**
...
- [ ] **Step 5: Verificar la compilación** — Run: `cd apps/flutter && flutter analyze`

- [ ] **Step 6: Commit**

---

### Task 2: Componentes comunes — DataTableWrapper
...
### Task 3: Componentes comunes — FormDialog + ConfirmDialog + StatCard
...
### Task 4-20: Creación masiva de páginas de módulos

> Cada task cubre un módulo; todas las páginas de lista siguen el patrón CRUD unificado.

**Plantilla estándar de página de lista CRUD** (~70 líneas por página):
...
**Lista de creación de páginas**:

| Task | Módulo | Directorio | Nº de páginas |
|------|------|------|--------|
| 4 | Productos | `pages/product/` | 4 |
| 5 | Contrapartes | `pages/partner/` | 4 |
| 6 | Compras | `pages/purchase/` | 4 |
| 7 | Ventas | `pages/sales/` | 4 |
| 8 | Inventario | `pages/inventory/` | 5 |
| 9 | Finanzas 1 (comprobantes/CxC-CxP/cobros y pagos/diario/reembolsos) | `pages/finance/` | 6 |
| 10 | Finanzas 2 (libro mayor/informes/activos/impuestos/monedas/presupuestos/costes) | `pages/finance/` | 7 |
| 11 | CRM | `pages/crm/` | 8 |
| 12 | OMS | `pages/oms/` | 4 |
| 13 | WMS | `pages/wms/` | 7 |
| 14 | TMS | `pages/tms/` | 5 |
| 15 | Fabricación | `pages/manufacturing/` | 5 |
| 16 | RR. HH. | `pages/hr/` | 6 |
| 17 | Proyectos | `pages/project/` | 3 |
| 18 | Flujo de aprobación | `pages/workflow/` | 2 |
| 19 | Notificaciones | `pages/notification/` | 1 |
| 20 | Informes personalizados | `pages/report/` | 2 |

Después de cada task: actualizar `main.dart` añadiendo la ruta correspondiente + verificar con `flutter analyze`.

---

### Task 21: Ampliación del panel de control
...
- [ ] **Step 1: Añadir los paneles OMS/WMS/TMS sobre las 4 pestañas existentes**

TabBar añade: `const Tab(text: 'OMS')`, `const Tab(text: 'WMS')`, `const Tab(text: 'TMS')`
TabBarView añade los métodos correspondientes `_omsTab()`, `_wmsTab()`, `_tmsTab()`, cada uno con 3-4 StatCard.

- [ ] **Step 2: Commit**

---

### Task 22: Registro completo de rutas + verificación final

- [ ] **Step 1: Completar todos los registros GetPage en main.dart**
- [ ] **Step 2: `flutter analyze` → No issues found**
- [ ] **Step 3: `flutter run -d chrome` para la aceptación manual de los menús y páginas de los 14 módulos**
- [ ] **Step 4: Commit**

---

### Task 23: Alineación con HarmonyOS

**Files:** crear nuevas páginas en `apps/harmonyos/entry/src/main/ets/pages/`

- [ ] Crear páginas ArkTS para los 8 módulos: OMS/WMS/TMS/Fabricación/RR. HH./Aprobación/Notificaciones/Informes
- [ ] Actualizar `main_pages.json` para registrar las rutas
- [ ] Verificar la compilación

---

**Criterios de aceptación (P0 complete):**
- [ ] Los 14 módulos de la barra lateral de Flutter Web son todos navegables
- [ ] Todas las páginas de lista CRUD cargan, paginan y buscan correctamente
- [ ] Los diálogos de creación/edición + confirmación de borrado con contraseña funcionan
- [ ] El diseño responsive de PC/tableta/móvil es correcto
- [ ] El JWT expirado se refresca automáticamente
- [ ] Nº de páginas HarmonyOS ≥ 80% de las páginas Flutter
