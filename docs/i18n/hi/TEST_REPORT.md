...
> संशोधन: api-tester को संदेह था कि `erp_admin_config` तालिका गायब है —— **कोई बग नहीं**। वास्तविक तालिका नाम `erp_system_config` है (install.sql:133 में बनी, SystemConfig मॉडल सही इंगित करता है), रिपोर्ट में सुधार किया गया।
