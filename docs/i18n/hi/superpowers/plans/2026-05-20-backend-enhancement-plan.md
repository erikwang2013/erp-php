...
**Goal:** 13 बैकएंड संवर्द्धन लागू करें: 3 नए मिडलवेयर (CORS, RateLimit, OperationLog), 6 नए कंट्रोलर, 2 मॉडल संशोधन, रूट + मिडलवेयर कॉन्फ़िगरेशन।

**Architecture:** मौजूदा webman पैटर्न का पालन — मिडलवेयर `MiddlewareInterface::process()` लागू करते हैं, कंट्रोलर `BaseController` से विरासत लेते हैं, रूट क्लोज़र या `[class, method]` से परिभाषित होते हैं। वैश्विक मिडलवेयर `config/middleware.php` में पंजीकृत, रूट-स्तरीय मिडलवेयर `config/route.php` में रूट समूहों पर लगे।
...
### Task 1: AdminUser मॉडल में SoftDeletes + Searchable trait
...
`app/model/AdminUser.php` की पंक्ति 10 के बाद दो `use` आयात जोड़ें, और क्लास बॉडी की शुरुआत में दो trait उपयोग करें:
...
### Task 3: RateLimit रेट लिमिट मिडलवेयर
...
### Task 5: वैश्विक मिडलवेयर कॉन्फ़िगरेशन

**Files:**
- Modify: `config/middleware.php`

- [ ] **Step 1: वैश्विक मिडलवेयर पंजीकृत करें**

`config/middleware.php` की सामग्री बदलें:
...
### Task 6: स्वास्थ्य जांच कंट्रोलर
...
- Modify: `app/middleware/AdminAuth.php` (JWT ब्लैकलिस्ट जांच)

- [ ] **Step 1: AdminAuth मिडलवेयर संशोधित करें, JWT ब्लैकलिस्ट जांच जोड़ें**

`AdminAuth::process()` विधि में, token निकालने के बाद और JWT डिकोड करने से पहले ब्लैकलिस्ट जांच डालें:
...
साथ ही Redis आयात जोड़ना आवश्यक है। फ़ाइल हेडर संशोधित करें:
...
`/admin` रूट समूह में नए रूट जोड़ें, साथ ही OperationLog मिडलवेयर जोड़ें। पूर्ण रूट फ़ाइल:
...
कार्यान्वयन पूर्ण होने के बाद, आइटम-दर-आइटम सत्यापन:
