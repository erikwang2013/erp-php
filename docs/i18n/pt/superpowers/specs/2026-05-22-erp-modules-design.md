...
- Prefixo de tabelas `erik_`, soft deletes, funções globais sem `\`
...
Todas as tabelas com prefixo `erik_`, `id` BIGINT não auto-incrementado, com `created_at`/`updated_at`/`deleted_at`.
