...
| Testes unitários | 113 arquivos de teste <!-- stats:test_files=113 --> / 1046<!-- stats:tests=1046 --> casos de teste / 5029<!-- stats:assertions=5029 --> asserções (contagem estática: número de métodos de teste + pontos de chamada de asserção, independente do ambiente de execução) |
