...
| Testes unitários | 113 arquivos de teste <!-- stats:test_files=113 --> / 1051<!-- stats:tests=1051 --> casos de teste / 5047<!-- stats:assertions=5047 --> asserções (contagem estática: número de métodos de teste + pontos de chamada de asserção, independente do ambiente de execução) |
