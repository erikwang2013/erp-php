...
| Testes unitários | 113 arquivos de teste <!-- stats:test_files=113 --> / 1048<!-- stats:tests=1048 --> casos de teste / 5040<!-- stats:assertions=5040 --> asserções (contagem estática: número de métodos de teste + pontos de chamada de asserção, independente do ambiente de execução) |
