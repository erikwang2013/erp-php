...
| Testes unitários | 50 arquivos de teste <!-- stats:test_files=109 --> / 442 casos de teste / 2238 asserções (tests/assertions flutuam com as versões de patch do PHP e extensões, não participam da validação precisa do stats) |
