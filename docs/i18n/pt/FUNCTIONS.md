...
| Testes unitários | 113 arquivos de teste <!-- stats:test_files=113 --> / 1055<!-- stats:tests=1055 --> casos de teste / 5056<!-- stats:assertions=5056 --> asserções (contagem estática: número de métodos de teste + pontos de chamada de asserção, independente do ambiente de execução) |
