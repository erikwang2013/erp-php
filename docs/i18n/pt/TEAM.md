...
| Baseline de qualidade | PHPUnit 1048<!-- stats:tests=1048 --> testes / 5040<!-- stats:assertions=5040 --> asserções, PHPStan + baseline, CS-Fixer, matriz de múltiplas versões no CI | Já há disciplina; os papéis de teste/revisão entram direto no pipeline |
...
```
phpunit            # 1048<!-- stats:tests=1048 --> testes / 5040<!-- stats:assertions=5040 --> asserções tudo verde; novos casos acompanham a alteração
