...
| Baseline de qualidade | PHPUnit 1055<!-- stats:tests=1055 --> testes / 5056<!-- stats:assertions=5056 --> asserções, PHPStan + baseline, CS-Fixer, matriz de múltiplas versões no CI | Já há disciplina; os papéis de teste/revisão entram direto no pipeline |
...
```
phpunit            # 1055<!-- stats:tests=1055 --> testes / 5056<!-- stats:assertions=5056 --> asserções tudo verde; novos casos acompanham a alteração
