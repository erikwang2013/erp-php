...
| Baseline de qualidade | PHPUnit 1037 testes / 4962 asserções, PHPStan + baseline, CS-Fixer, matriz de múltiplas versões no CI | Já há disciplina; os papéis de teste/revisão entram direto no pipeline |
...
```
phpunit            # 1037 testes / 4962 asserções tudo verde; novos casos acompanham a alteração
