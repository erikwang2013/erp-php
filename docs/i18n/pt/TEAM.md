...
| Baseline de qualidade | PHPUnit 1051<!-- stats:tests=1051 --> testes / 5047<!-- stats:assertions=5047 --> asserções, PHPStan + baseline, CS-Fixer, matriz de múltiplas versões no CI | Já há disciplina; os papéis de teste/revisão entram direto no pipeline |
...
```
phpunit            # 1051<!-- stats:tests=1051 --> testes / 5047<!-- stats:assertions=5047 --> asserções tudo verde; novos casos acompanham a alteração
