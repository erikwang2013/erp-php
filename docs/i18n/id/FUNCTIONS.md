...
| Unit test | 111 file pengujian <!-- stats:test_files=111 --> / 1001 kasus pengujian <!-- stats:tests=1008 --> / 4726 asersi <!-- stats:assertions=4768 --> (hitungan statis: jumlah metode pengujian + titik pemanggilan asersi, tidak bergantung pada lingkungan eksekusi) |
