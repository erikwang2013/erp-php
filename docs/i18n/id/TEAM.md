...
| Baseline kualitas | PHPUnit 1048<!-- stats:tests=1048 --> test / 5040<!-- stats:assertions=5040 --> assertion, PHPStan + baseline, CS-Fixer, matriks multi-versi CI | Disiplin sudah ada, peran pengujian/review langsung tertanam ke pipeline |
...
```
phpunit            # 1048<!-- stats:tests=1048 --> test / 5040<!-- stats:assertions=5040 --> assertion semua hijau, kasus baru ikut dikirim bersama perubahan
