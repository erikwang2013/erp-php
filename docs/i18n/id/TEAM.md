...
| Baseline kualitas | PHPUnit 1044<!-- stats:tests=1044 --> test / 5020<!-- stats:assertions=5020 --> assertion, PHPStan + baseline, CS-Fixer, matriks multi-versi CI | Disiplin sudah ada, peran pengujian/review langsung tertanam ke pipeline |
...
```
phpunit            # 1044<!-- stats:tests=1044 --> test / 5020<!-- stats:assertions=5020 --> assertion semua hijau, kasus baru ikut dikirim bersama perubahan
