...
| Baseline kualitas | PHPUnit 1051<!-- stats:tests=1051 --> test / 5047<!-- stats:assertions=5047 --> assertion, PHPStan + baseline, CS-Fixer, matriks multi-versi CI | Disiplin sudah ada, peran pengujian/review langsung tertanam ke pipeline |
...
```
phpunit            # 1051<!-- stats:tests=1051 --> test / 5047<!-- stats:assertions=5047 --> assertion semua hijau, kasus baru ikut dikirim bersama perubahan
