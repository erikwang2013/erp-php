...
| Baseline kualitas | PHPUnit 1055<!-- stats:tests=1055 --> test / 5056<!-- stats:assertions=5056 --> assertion, PHPStan + baseline, CS-Fixer, matriks multi-versi CI | Disiplin sudah ada, peran pengujian/review langsung tertanam ke pipeline |
...
```
phpunit            # 1055<!-- stats:tests=1055 --> test / 5056<!-- stats:assertions=5056 --> assertion semua hijau, kasus baru ikut dikirim bersama perubahan
