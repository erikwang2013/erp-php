...
| | تجمع فواتير المشتريات + الفاتورة الإلكترونية | إدارة فواتير المشتريات + قناة الإصدار (محول + قناة تجريبية Mock) | ذمم مدينة/دائنة / مقبوضات-مدفوعات / دفتر يومية / مصاريف / بيان الأرباح / أصول ثابتة / ضرائب / عملات متعددة / ميزانيات / مراكز تكلفة وأرباح | توليد تلقائي للذمم + تسوية + إدارة مالية شاملة |
...
تبديل تلقائي عبر ترويسة `Accept-Language` (zh-CN / en)، والافتراضي هو الصينية.
