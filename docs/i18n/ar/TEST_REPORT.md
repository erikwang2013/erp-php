...
> تصحيح: شكّ api-tester سابقًا في فقدان جدول `erp_admin_config` — **ليس عيبًا**. اسم الجدول الحقيقي `erp_system_config` (مُنشأ في install.sql:133، ونموذج SystemConfig يشير إليه بشكل صحيح)، ويصحح التقرير ذلك.
