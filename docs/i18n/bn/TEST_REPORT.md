...
> ভুল সংশোধন: api-tester একবার সন্দেহ করেছিল `erik_admin_config` টেবিল অনুপস্থিত —— **ত্রুটি নয়**। প্রকৃত টেবিলের নাম `erik_system_config` (install.sql:133 এ তৈরি, SystemConfig মডেল সঠিক পয়েন্ট করে), রিপোর্টে সংশোধন করা হলো।
