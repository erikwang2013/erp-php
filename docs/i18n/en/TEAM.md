...
| Quality baseline | PHPUnit 1055<!-- stats:tests=1055 --> tests / 5056<!-- stats:assertions=5056 --> assertions, PHPStan + baseline, CS-Fixer, CI multi-version matrix | Discipline already in place; testing/review roles plug directly into the pipeline |
...
```
phpunit            # 1055<!-- stats:tests=1055 --> tests / 5056<!-- stats:assertions=5056 --> assertions all green; new cases submitted with changes
