...
| Quality baseline | PHPUnit 1046<!-- stats:tests=1046 --> tests / 5029<!-- stats:assertions=5029 --> assertions, PHPStan + baseline, CS-Fixer, CI multi-version matrix | Discipline already in place; testing/review roles plug directly into the pipeline |
...
```
phpunit            # 1046<!-- stats:tests=1046 --> tests / 5029<!-- stats:assertions=5029 --> assertions all green; new cases submitted with changes
