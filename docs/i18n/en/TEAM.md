...
| Quality baseline | PHPUnit 1044<!-- stats:tests=1044 --> tests / 5020<!-- stats:assertions=5020 --> assertions, PHPStan + baseline, CS-Fixer, CI multi-version matrix | Discipline already in place; testing/review roles plug directly into the pipeline |
...
```
phpunit            # 1044<!-- stats:tests=1044 --> tests / 5020<!-- stats:assertions=5020 --> assertions all green; new cases submitted with changes
