# P0-Flutter-Web-Verwaltungspanel — Implementierungsplan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Das Flutter-Web-Verwaltungspanel von den vorhandenen ~12 Seiten auf 40+ Seiten für alle 14 Backend-Module erweitern und eine wiederverwendbare Allzweck-Komponentenbibliothek aufbauen.

**Architecture:** Umbau auf ein konfigurationsgesteuertes dynamisches Menüsystem (`menu_config.dart`), PC-Dreispalten-Layout (einklappbare Seitenleiste + Kopfleiste + Inhaltsbereich), Allzweck-CRUD-Komponenten (DataTableWrapper/FormDialog/ConfirmDialog) zur Wiederverwendung in den Seiten aller Module.
...
### Task 1: Menükonfiguration und Routen-Refactoring

**Files:**
- Create: `apps/flutter/lib/app/config/menu_config.dart`
- Modify: `apps/flutter/lib/app/layouts/admin_layout.dart` (komplette Neufassung)
- Modify: `apps/flutter/lib/main.dart` (Routenregistrierung)
- Move: vorhandene Seiten-Dateien in die neue Verzeichnisstruktur verschieben

- [ ] **Step 1: menu_config.dart erstellen**
...
- [ ] **Step 2: AdminLayout neu schreiben, dynamische Menü-Renderung unterstützen**
...
- [ ] **Step 3: main.dart aktualisieren — zentrale Routenregistrierung**
...
- [ ] **Step 4: Vorhandene Seiten-Dateiverzeichnisse migrieren**
...
- [ ] **Step 5: Kompilierung verifizieren** — Ausführen: `cd apps/flutter && flutter analyze`

- [ ] **Step 6: Commit**

---

### Task 2: Allzweck-Komponenten — DataTableWrapper

**Files:** Erstellen: `apps/flutter/lib/app/widgets/data_table_wrapper.dart`
...
### Task 3: Allzweck-Komponenten — FormDialog + ConfirmDialog + StatCard

**Files:**
- Erstellen: `apps/flutter/lib/app/widgets/form_dialog.dart`
- Erstellen: `apps/flutter/lib/app/widgets/confirm_dialog.dart`
- Erstellen: `apps/flutter/lib/app/widgets/stat_card.dart`

- [ ] **Step 1: FormDialog erstellen**
...
- [ ] **Step 2: ConfirmDialog erstellen**
...
### Task 4-20: Modulseiten-Batch-Erstellung

> Jeder Task deckt ein Modul ab, alle Listen-Seiten folgen dem einheitlichen CRUD-Muster.

**Standardvorlage für CRUD-Listen-Seiten** (jede Seite ~70 Zeilen):
...
**Checkliste zur Seitenerstellung**:

| Task | Modul | Verzeichnis | Seitenzahl |
|------|------|------|--------|
| 4 | Artikel | `pages/product/` | 4 |
| 5 | Geschäftspartner | `pages/partner/` | 4 |
| 6 | Einkauf | `pages/purchase/` | 4 |
| 7 | Verkauf | `pages/sales/` | 4 |
| 8 | Bestand | `pages/inventory/` | 5 |
| 9 | Finanzen 1 (Belege/Forderungen-Verbindlichkeiten/Zahlungen/Tagebuch/Spesenabrechnung) | `pages/finance/` | 6 |
| 10 | Finanzen 2 (Hauptbuch/Berichte/Anlagen/Steuern/Währungen/Budget/Kosten) | `pages/finance/` | 7 |
| 11 | CRM | `pages/crm/` | 8 |
| 12 | OMS | `pages/oms/` | 4 |
| 13 | WMS | `pages/wms/` | 7 |
| 14 | TMS | `pages/tms/` | 5 |
| 15 | Fertigung | `pages/manufacturing/` | 5 |
| 16 | HR | `pages/hr/` | 6 |
| 17 | Projekte | `pages/project/` | 3 |
| 18 | Genehmigungsworkflow | `pages/workflow/` | 2 |
| 19 | Benachrichtigungen | `pages/notification/` | 1 |
| 20 | Benutzerdefinierte Berichte | `pages/report/` | 2 |

Nach jedem Task: `main.dart` um die entsprechende Route ergänzen + mit `flutter analyze` verifizieren.

---

### Task 21: Dashboard-Erweiterung

**Files:**
- Ändern: `apps/flutter/lib/app/pages/dashboard/dashboard_page.dart`
- Ändern: `apps/flutter/lib/app/pages/dashboard/dashboard_controller.dart`

- [ ] **Step 1: Über die vorhandenen 4 Tabs hinaus OMS/WMS/TMS-Dashboards ergänzen**

TabBar ergänzen: `const Tab(text: 'OMS')`, `const Tab(text: 'WMS')`, `const Tab(text: 'TMS')`
TabBarView mit entsprechenden `_omsTab()`, `_wmsTab()`, `_tmsTab()`-Methoden ergänzen, jede mit 3-4 StatCards.

- [ ] **Step 2: Commit**

---

### Task 22: Vollständige Routenregistrierung + finale Verifizierung

- [ ] **Step 1: main.dart um alle GetPage-Registrierungen vervollständigen**
- [ ] **Step 2: `flutter analyze` → No issues found**
- [ ] **Step 3: `flutter run -d chrome` — manuelle Abnahme aller 14 Modul-Menüs und Seiten**
- [ ] **Step 4: Commit**

---

### Task 23: HarmonyOS-Angleichung

**Files:** Neue Seiten unter `apps/harmonyos/entry/src/main/ets/pages/` erstellen

- [ ] ArkTS-Seiten für insgesamt 8 Module erstellen: OMS/WMS/TMS/Fertigung/HR/Genehmigung/Benachrichtigungen/Berichte
- [ ] `main_pages.json` um Routenregistrierungen aktualisieren
- [ ] Kompilierung verifizieren

---

**Abnahmekriterien (P0 abgeschlossen):**
- [ ] Alle 14 Module der Flutter-Web-Seitenleiste navigierbar
- [ ] Alle CRUD-Listen-Seiten laden normal, mit Paginierung und Suche
- [ ] Erstellen/Bearbeiten-Dialoge + Löschen-Passwortbestätigung funktionsfähig
- [ ] PC/Tablet/Mobil responsive Layouts funktionieren normal
- [ ] JWT-Ablauf mit automatischer Aktualisierung
- [ ] HarmonyOS-Seitenzahl ≥ 80 % der Flutter-Seiten
