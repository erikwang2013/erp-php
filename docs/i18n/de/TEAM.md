...
| Qualitätsbasis | PHPUnit 1048<!-- stats:tests=1048 --> Tests / 5040<!-- stats:assertions=5040 --> Assertions, PHPStan + baseline, CS-Fixer, CI-Multiversionsmatrix | Disziplin vorhanden; Test-/Review-Rolle direkt in die Pipeline eingebunden |
...
```
phpunit            # 1048<!-- stats:tests=1048 --> Tests / 5040<!-- stats:assertions=5040 --> Assertions komplett grün, neue Fälle mit der Änderung einreichen
