...
| Qualitätsbasis | PHPUnit 1046<!-- stats:tests=1046 --> Tests / 5029<!-- stats:assertions=5029 --> Assertions, PHPStan + baseline, CS-Fixer, CI-Multiversionsmatrix | Disziplin vorhanden; Test-/Review-Rolle direkt in die Pipeline eingebunden |
...
```
phpunit            # 1046<!-- stats:tests=1046 --> Tests / 5029<!-- stats:assertions=5029 --> Assertions komplett grün, neue Fälle mit der Änderung einreichen
