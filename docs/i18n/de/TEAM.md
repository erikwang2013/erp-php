...
| Qualitätsbasis | PHPUnit 1001 Tests / 4726 Assertions, PHPStan + baseline, CS-Fixer, CI-Multiversionsmatrix | Disziplin vorhanden; Test-/Review-Rolle direkt in die Pipeline eingebunden |
...
```
phpunit            # 1001 Tests / 4726 Assertions komplett grün, neue Fälle mit der Änderung einreichen
