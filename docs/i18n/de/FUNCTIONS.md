...
| Datenbanktabellen | 163 <!-- stats:tables=227 --> |
| Datenmodelle | 161 <!-- stats:models=224 --> |
| Controller | 123 <!-- stats:controllers=159 --> |
| Business-Services | 27 <!-- stats:services=64 --> |
...
| PHP-Quelldateien | 343 <!-- stats:php_files=483 --> |
...
| Unit-Tests | 50 Testdateien <!-- stats:test_files=111 --> / 442 Testfälle / 2238 Assertions (tests/assertions schwanken mit PHP-Patchversionen und Erweiterungen, nehmen nicht an der exakten stats-Prüfung teil) |
