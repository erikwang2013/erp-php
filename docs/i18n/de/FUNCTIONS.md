...
| PHP-Quelldateien | 343 <!-- stats:php_files=481 --> |
...
| Unit-Tests | 50 Testdateien <!-- stats:test_files=108 --> / 442 Testfälle / 2238 Assertions (tests/assertions schwanken mit PHP-Patchversionen und Erweiterungen, nehmen nicht an der exakten stats-Prüfung teil) |
