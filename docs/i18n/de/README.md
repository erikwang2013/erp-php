...
├── tests/                      # PHPUnit-Tests (111 Testdateien <!-- stats:test_files=113 -->, 1001 Testmethoden <!-- stats:tests=1037 -->, 4726 Assertions <!-- stats:assertions=4962 -->; Zählweise siehe Anhang in FUNCTIONS.md)
├── resource/
