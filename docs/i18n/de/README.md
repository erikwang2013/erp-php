...
├── tests/                      # PHPUnit-Tests (113<!-- stats:test_files=113 --> Testdateien , 1048<!-- stats:tests=1048 --> Testmethoden , 5040<!-- stats:assertions=5040 --> Assertions ; Zählweise siehe Anhang in FUNCTIONS.md)
├── resource/
