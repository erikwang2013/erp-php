...
├── tests/                      # PHPUnit-Tests (113<!-- stats:test_files=113 --> Testdateien , 1055<!-- stats:tests=1055 --> Testmethoden , 5056<!-- stats:assertions=5056 --> Assertions ; Zählweise siehe Anhang in FUNCTIONS.md)
├── resource/
