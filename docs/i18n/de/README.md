...
├── tests/                      # PHPUnit-Tests (113<!-- stats:test_files=113 --> Testdateien , 1051<!-- stats:tests=1051 --> Testmethoden , 5047<!-- stats:assertions=5047 --> Assertions ; Zählweise siehe Anhang in FUNCTIONS.md)
├── resource/
