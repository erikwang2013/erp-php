...
├── tests/                      # PHPUnit-Tests (111 Testdateien <!-- stats:test_files=113 -->, 1001 Testmethoden <!-- stats:tests=1025 -->, 4726 Assertions <!-- stats:assertions=4827 -->; Zählweise siehe Anhang in FUNCTIONS.md)
├── resource/
