...
| 品質ベースライン | PHPUnit 1037 テスト / 4962 アサーション、PHPStan + baseline、CS-Fixer、CI 多バージョンマトリクス | 規律は確立済み。テスト/レビューのロールをパイプラインに直接組み込む |
...
```
phpunit            # 1037 テスト / 4962 アサーション全緑、新規ケースは変更とともにコミット
