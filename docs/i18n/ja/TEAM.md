...
| 品質ベースライン | PHPUnit 1051<!-- stats:tests=1051 --> テスト / 5047<!-- stats:assertions=5047 --> アサーション、PHPStan + baseline、CS-Fixer、CI 多バージョンマトリクス | 規律は確立済み。テスト/レビューのロールをパイプラインに直接組み込む |
...
```
phpunit            # 1051<!-- stats:tests=1051 --> テスト / 5047<!-- stats:assertions=5047 --> アサーション全緑、新規ケースは変更とともにコミット
