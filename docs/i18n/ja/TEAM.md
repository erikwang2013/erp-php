...
| 品質ベースライン | PHPUnit 1048<!-- stats:tests=1048 --> テスト / 5040<!-- stats:assertions=5040 --> アサーション、PHPStan + baseline、CS-Fixer、CI 多バージョンマトリクス | 規律は確立済み。テスト/レビューのロールをパイプラインに直接組み込む |
...
```
phpunit            # 1048<!-- stats:tests=1048 --> テスト / 5040<!-- stats:assertions=5040 --> アサーション全緑、新規ケースは変更とともにコミット
