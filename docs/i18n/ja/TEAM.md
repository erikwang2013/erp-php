...
| 品質ベースライン | PHPUnit 1055<!-- stats:tests=1055 --> テスト / 5056<!-- stats:assertions=5056 --> アサーション、PHPStan + baseline、CS-Fixer、CI 多バージョンマトリクス | 規律は確立済み。テスト/レビューのロールをパイプラインに直接組み込む |
...
```
phpunit            # 1055<!-- stats:tests=1055 --> テスト / 5056<!-- stats:assertions=5056 --> アサーション全緑、新規ケースは変更とともにコミット
