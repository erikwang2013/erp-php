...
开放ERP系统 (open-erp) 覆盖 19 个业务域 <!-- stats:modules=23 -->，163 张数据表 <!-- stats:tables=226 -->，提供从进销存到生产制造、从财务核算到人力资源的全栈企业管理系统。国际化: 中文/English 双语支持，Accept-Language 请求头自动切换。
...
| 单元测试 | 59 个测试文件 <!-- stats:test_files=107 --> / 500 个测试用例 <!-- stats:tests=948 --> / 2226 条断言 <!-- stats:assertions=2063 -->（51 skipped）|
