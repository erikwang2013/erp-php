...
| 质量基线 | PHPUnit 1051<!-- stats:tests=1051 --> 测试 / 5047<!-- stats:assertions=5047 --> 断言、PHPStan + baseline、CS-Fixer、CI 多版本矩阵 | 已具备纪律，测试/审查角色直接嵌入流水线 |
...
```
phpunit            # 1051<!-- stats:tests=1051 --> 测试 / 5047<!-- stats:assertions=5047 --> 断言全绿，新增用例随改动提交
