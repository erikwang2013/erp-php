...
| 质量基线 | PHPUnit 1055<!-- stats:tests=1055 --> 测试 / 5056<!-- stats:assertions=5056 --> 断言、PHPStan + baseline、CS-Fixer、CI 多版本矩阵 | 已具备纪律，测试/审查角色直接嵌入流水线 |
...
```
phpunit            # 1055<!-- stats:tests=1055 --> 测试 / 5056<!-- stats:assertions=5056 --> 断言全绿，新增用例随改动提交
