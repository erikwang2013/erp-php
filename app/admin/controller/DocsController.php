...
#[\erikwang2013\apidoc\annotation\Tag("API文档")]
#[\erikwang2013\apidoc\annotation\Returned("openapi", type:"string", desc:"OpenAPI版本号")]
#[\erikwang2013\apidoc\annotation\Returned("info", type:"object", desc:"API基本信息")]
#[\erikwang2013\apidoc\annotation\Returned("paths", type:"object", desc:"接口路径定义")]
    ...
    private function buildSpec(): array
    {
        ...
        return [
            ...
            'info' => [
                'title' => '开放管理后台 API',
                'description' => '基于 webman v2 的全栈管理后台系统。API 版本置于 URL 路径（如 /api/v1/auth/login），无需任何版本请求头。',
                'version' => '1.0.0',
            ...
            'paths' => [
                ...
                '/api/v1/auth/register' => $this->path('注册', 'POST', null, 'object', ['username' => 'string', 'password' => 'string', 'real_name' => 'string', 'captcha_key' => 'string', 'clicks' => 'array']),
