...
class FinalCheckController extends BaseController
{
    /**
     * 出货检验记录列表（分页）
     * @Apidoc\Title("出货检验记录列表")
     * @Apidoc\Desc("获取出货检验(OQC)记录列表，支持分页、单号关键词搜索和结果筛选")
     * @Apidoc\Url("/admin/v1/quality/oqc")
     * @Apidoc\Method("GET")
     * @Apidoc\Author("erik")
     * @Apidoc\Tag("质量管理")
    ...
    /**
     * 创建出货检验记录
     * @Apidoc\Title("创建出货检验记录")
     * @Apidoc\Desc("新增一条出货检验(OQC)记录，检验单号/检验数量/检验结果必填")
     * @Apidoc\Url("/admin/v1/quality/oqc")
     * @Apidoc\Method("POST")
     * @Apidoc\Author("erik")
     * @Apidoc\Tag("质量管理")
    ...
    /**
     * 出货检验记录详情
     * @Apidoc\Title("出货检验记录详情")
     * @Apidoc\Desc("根据ID获取出货检验(OQC)记录详细信息")
     * @Apidoc\Url("/admin/v1/quality/oqc/{id}")
     * @Apidoc\Method("GET")
     * @Apidoc\Author("erik")
     * @Apidoc\Tag("质量管理")
    ...
    /**
     * 更新出货检验记录
     * @Apidoc\Title("更新出货检验记录")
     * @Apidoc\Desc("根据ID更新出货检验(OQC)记录信息")
     * @Apidoc\Url("/admin/v1/quality/oqc/{id}")
     * @Apidoc\Method("PUT")
     * @Apidoc\Author("erik")
     * @Apidoc\Tag("质量管理")
    ...
    /**
     * 删除出货检验记录（软删除）
     * @Apidoc\Title("删除出货检验记录")
     * @Apidoc\Desc("根据ID软删除出货检验(OQC)记录，需管理员密码二次确认")
     * @Apidoc\Url("/admin/v1/quality/oqc/{id}")
