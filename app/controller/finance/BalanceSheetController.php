...
class BalanceSheetController extends BaseController
{
    ...
    #[\erikwang2013\apidoc\annotation\Returned('data', type:'object', desc:'资产负债表数据')]
    ...
    public function index(Request $request): Response
    {
        ...
        if ($snapshot) {
            ...
            // 解码后再编码：report_data 是串时 encodeIds 下不去，lines[].account_id 裸 ID 直接外泄
        ...
        $reportData = $report;
        $reportData['report_data'] = $this->encodeIds($this->decodeReportData($report['report_data'] ?? null), ['account_id']);
