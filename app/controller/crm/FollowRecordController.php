...
class FollowRecordController extends BaseController
{
     ...
     * 跟进记录列表（分页）
     * @Apidoc\Title("跟进记录列表")
     * @Apidoc\Desc("分页查询跟进记录记录")
     * @Apidoc\Url("/admin/v1/crm/follow")
     * @Apidoc\Method("GET")
     * @Apidoc\Author("erik")
     * @Apidoc\Tag("CRM")
     ...
     * 创建跟进记录
     * @Apidoc\Title("创建跟进记录")
     * @Apidoc\Desc("新增跟进记录记录")
     * @Apidoc\Url("/admin/v1/crm/follow")
     * @Apidoc\Method("POST")
     * @Apidoc\Author("erik")
     * @Apidoc\Tag("CRM")
     * @Apidoc\Param(name="name", type="string", desc="跟进记录名称，必填")
     * @Apidoc\Returned("code", type="int", desc="业务代码,0=成功")
     * @Apidoc\Returned("message", type="string", desc="业务信息")
     * @Apidoc\Returned("data", type="object", desc="业务数据")
     */
     ...
     * 跟进记录详情
     * @Apidoc\Title("跟进记录详情")
     * @Apidoc\Desc("查看跟进记录详细信息")
     * @Apidoc\Url("/admin/v1/crm/follow/{id}")
     * @Apidoc\Method("GET")
     * @Apidoc\Author("erik")
     * @Apidoc\Tag("CRM")
     * @Apidoc\Param(name="id", type="string", desc="跟进记录ID")
     * @Apidoc\Returned("code", type="int", desc="业务代码,0=成功")
     * @Apidoc\Returned("message", type="string", desc="业务信息")
     * @Apidoc\Returned("data", type="object", desc="业务数据")
     */
