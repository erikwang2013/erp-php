...
#[\erikwang2013\apidoc\annotation\Returned("data", type:"object", desc:"业务数据")]
    ...
    public function index(Request $request): Response
    {
        ...
        $result = $this->product()->list(Warehouse::class, [
            'keyword' => $keyword,
            'status' => $status,
        ], $page, $limit, [
     ...
     * @Apidoc\Author("erik")
     * @Apidoc\Tag("CRM")
     * @Apidoc\Param(name="name", type="string", desc="仓库名称，必填")
     * @Apidoc\Returned("code", type="int", desc="业务代码,0=成功")
     * @Apidoc\Returned("message", type="string", desc="业务信息")
     * @Apidoc\Returned("data", type="object", desc="业务数据")
...
#[\erikwang2013\apidoc\annotation\Author("erik")]
#[\erikwang2013\apidoc\annotation\Tag("CRM")]
#[\erikwang2013\apidoc\annotation\Param(name:"name", type:"string", desc:"仓库名称，必填")]
#[\erikwang2013\apidoc\annotation\Returned("code", type:"int", desc:"业务代码,0=成功")]
#[\erikwang2013\apidoc\annotation\Returned("message", type:"string", desc:"业务信息")]
#[\erikwang2013\apidoc\annotation\Returned("data", type:"object", desc:"业务数据")]
    ...
    public function store(Request $request): Response
    {
        ...
        $item = $this->product()->create(Warehouse::class, $request->all());
     ...
     * @Apidoc\Author("erik")
     * @Apidoc\Tag("CRM")
     * @Apidoc\Param(name="id", type="string", desc="仓库ID")
     * @Apidoc\Returned("code", type="int", desc="业务代码,0=成功")
     * @Apidoc\Returned("message", type="string", desc="业务信息")
     * @Apidoc\Returned("data", type="object", desc="业务数据")
...
#[\erikwang2013\apidoc\annotation\Author("erik")]
#[\erikwang2013\apidoc\annotation\Tag("CRM")]
#[\erikwang2013\apidoc\annotation\Param(name:"id", type:"string", desc:"仓库ID")]
#[\erikwang2013\apidoc\annotation\Returned("code", type:"int", desc:"业务代码,0=成功")]
#[\erikwang2013\apidoc\annotation\Returned("message", type:"string", desc:"业务信息")]
#[\erikwang2013\apidoc\annotation\Returned("data", type:"object", desc:"业务数据")]
    ...
    {
        $id = $this->decodeId($id);
        $item = $this->product()->find(Warehouse::class, $id);
        if (!$item) {
...
#[\erikwang2013\apidoc\annotation\Returned("data", type:"object", desc:"业务数据")]
    ...
    {
        $id = $this->decodeId($id);
        $item = $this->product()->update(Warehouse::class, $id, $request->all());
        if (!$item) {
            return $this->fail('记录不存在', 404);
        }
...
#[\erikwang2013\apidoc\annotation\Returned("data", type:"object", desc:"业务数据")]
    ...
    public function destroy(Request $request, string $id): Response
    {
        ...
        $this->product()->delete(Warehouse::class, $id);
