...
class TrainingController extends BaseController
{
     ...
     * 课程列表（分页）
     * @Apidoc\Title("课程列表")
     * @Apidoc\Desc("按状态/类型/最低学分/关键词分页查询课程")
     * @Apidoc\Url("/admin/v1/hr/course")
     * @Apidoc\Method("GET")
     * @Apidoc\Author("erik")
     * @Apidoc\Tag("人力资源")
     * @Apidoc\Param(name="page", type="int", desc="页码")
     * @Apidoc\Param(name="limit", type="int", desc="每页条数")
     * @Apidoc\Param(name="status", type="int", desc="状态:0草稿1上架2下架")
     * @Apidoc\Param(name="course_type", type="string", desc="类型:internal内训/external外训/online线上")
     * @Apidoc\Param(name="min_credits", type="int", desc="最低学分")
     * @Apidoc\Param(name="keyword", type="string", desc="标题/讲师关键词")
...
#[\erikwang2013\apidoc\annotation\Returned("data", type:"object", desc:"业务数据")]
     ...
     * 创建课程
     * @Apidoc\Title("创建课程")
     * @Apidoc\Desc("title/course_type 必填；未传 status 落草稿(0)")
     * @Apidoc\Url("/admin/v1/hr/course")
     * @Apidoc\Method("POST")
     * @Apidoc\Author("erik")
     * @Apidoc\Tag("人力资源")
     * @Apidoc\Param(name="title", type="string", desc="课程标题，必填")
     * @Apidoc\Param(name="course_type", type="string", desc="类型:internal内训/external外训/online线上，必填")
     * @Apidoc\Param(name="lecturer", type="string", desc="讲师姓名")
     * @Apidoc\Param(name="credits", type="int", desc="学分，非负整数")
     * @Apidoc\Param(name="duration_hours", type="float", desc="课时时长，最多两位小数")
     * @Apidoc\Param(name="status", type="int", desc="状态:0草稿1上架2下架，缺省0")
     * @Apidoc\Returned("code", type="int", desc="业务代码,0=成功")
     * @Apidoc\Returned("message", type="string", desc="业务信息")
     * @Apidoc\Returned("data", type="object", desc="业务数据")
...
#[\erikwang2013\apidoc\annotation\Returned("data", type:"object", desc:"业务数据")]
     ...
     * 更新课程
     * @Apidoc\Title("更新课程")
     * @Apidoc\Desc("可部分更新；下架仅拦截新报名，不影响已有选课")
     * @Apidoc\Url("/admin/v1/hr/course/{id}")
     * @Apidoc\Method("PUT")
     * @Apidoc\Author("erik")
     * @Apidoc\Tag("人力资源")
     * @Apidoc\Param(name="id", type="string", desc="课程ID")
     * @Apidoc\Returned("code", type="int", desc="业务代码,0=成功")
     * @Apidoc\Returned("message", type="string", desc="业务信息")
     * @Apidoc\Returned("data", type="object", desc="业务数据")
...
#[\erikwang2013\apidoc\annotation\Returned("data", type:"object", desc:"业务数据")]
     ...
     * 员工报名课程
     * @Apidoc\Title("员工报名课程")
     * @Apidoc\Desc("仅上架课程可报名；同员工同课程仅一条选课，重复报名拒绝")
     * @Apidoc\Url("/admin/v1/hr/course/{id}/enroll")
     * @Apidoc\Method("POST")
     * @Apidoc\Author("erik")
     * @Apidoc\Tag("人力资源")
     * @Apidoc\Param(name="id", type="string", desc="课程ID")
...
#[\erikwang2013\apidoc\annotation\Returned("data", type:"object", desc:"业务数据")]
     ...
     * 取消课程报名
     * @Apidoc\Title("取消课程报名")
     * @Apidoc\Desc("已报名(0)→已取消(2)；已完成(1)不可取消")
     * @Apidoc\Url("/admin/v1/hr/course/{id}/cancel")
     * @Apidoc\Method("POST")
     * @Apidoc\Author("erik")
     * @Apidoc\Tag("人力资源")
     * @Apidoc\Param(name="id", type="string", desc="课程ID")
...
#[\erikwang2013\apidoc\annotation\Returned("data", type:"object", desc:"业务数据")]
     ...
     * 标记课程完成
     * @Apidoc\Title("标记课程完成")
     * @Apidoc\Desc("已报名(0)→已完成(1)并记 completed_at；学分计入员工学分")
     * @Apidoc\Url("/admin/v1/hr/course/{id}/complete")
     * @Apidoc\Method("POST")
     * @Apidoc\Author("erik")
     * @Apidoc\Tag("人力资源")
     * @Apidoc\Param(name="id", type="string", desc="课程ID")
...
#[\erikwang2013\apidoc\annotation\Returned("data", type:"object", desc:"业务数据")]
     ...
     * 员工学分统计
     * @Apidoc\Title("员工学分统计")
     * @Apidoc\Desc("已完成选课学分合计与选课历史（课程软删除后仍计入）")
     * @Apidoc\Url("/admin/v1/hr/employee-credits/{id}")
     * @Apidoc\Method("GET")
     * @Apidoc\Author("erik")
     * @Apidoc\Tag("人力资源")
