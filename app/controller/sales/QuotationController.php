...
class QuotationController extends BaseController
{
     ...
     * 销售报价列表（分页）
     * @Apidoc\Title("销售报价列表")
     * @Apidoc\Desc("获取销售报价列表，支持分页、关键词搜索和状态筛选")
     * @Apidoc\Url("/admin/v1/sales/quotation")
     * @Apidoc\Method("GET")
     * @Apidoc\Author("erik")
     * @Apidoc\Tag("销售管理")
...
#[\erikwang2013\apidoc\annotation\Returned("data", type:"object", desc:"业务数据")]
     ...
     * 创建销售报价
     * @Apidoc\Title("创建销售报价")
     * @Apidoc\Desc("新增一个销售报价记录")
     * @Apidoc\Url("/admin/v1/sales/quotation")
     * @Apidoc\Method("POST")
     * @Apidoc\Author("erik")
     * @Apidoc\Tag("销售管理")
     * @Apidoc\Param(name="name", type="string", default="", desc="报价名称（必填）")
     * @Apidoc\Param(name="code", type="string", default="", desc="报价单号")
     * @Apidoc\Param(name="status", type="int", default=1, desc="状态")
     * @Apidoc\Returned("code", type="int", desc="业务代码,0=成功")
     * @Apidoc\Returned("message", type="string", desc="业务信息")
     * @Apidoc\Returned("data", type="object", desc="销售报价记录")
...
#[\erikwang2013\apidoc\annotation\Returned("data", type:"object", desc:"销售报价记录")]
     ...
     * 销售报价详情
     * @Apidoc\Title("销售报价详情")
     * @Apidoc\Desc("根据ID获取销售报价详细信息")
     * @Apidoc\Url("/admin/v1/sales/quotation/{id}")
     * @Apidoc\Method("GET")
     * @Apidoc\Author("erik")
     * @Apidoc\Tag("销售管理")
     * @Apidoc\Param(name="id", type="string", default="", desc="销售报价hashid")
     * @Apidoc\Returned("code", type="int", desc="业务代码,0=成功")
     * @Apidoc\Returned("message", type="string", desc="业务信息")
     * @Apidoc\Returned("data", type="object", desc="销售报价详情")
...
#[\erikwang2013\apidoc\annotation\Returned("data", type:"object", desc:"销售报价详情")]
     ...
     * 更新销售报价
     * @Apidoc\Title("更新销售报价")
     * @Apidoc\Desc("根据ID更新销售报价信息")
     * @Apidoc\Url("/admin/v1/sales/quotation/{id}")
     * @Apidoc\Method("PUT")
     * @Apidoc\Author("erik")
     * @Apidoc\Tag("销售管理")
     * @Apidoc\Param(name="id", type="string", default="", desc="销售报价hashid")
     * @Apidoc\Param(name="name", type="string", default="", desc="报价名称")
     * @Apidoc\Param(name="code", type="string", default="", desc="报价单号")
     * @Apidoc\Param(name="status", type="int", default="", desc="状态")
     * @Apidoc\Returned("code", type="int", desc="业务代码,0=成功")
     * @Apidoc\Returned("message", type="string", desc="业务信息")
     * @Apidoc\Returned("data", type="object", desc="更新后的销售报价记录")
...
#[\erikwang2013\apidoc\annotation\Returned("data", type:"object", desc:"更新后的销售报价记录")]
     ...
     * 删除销售报价（软删除）
     * @Apidoc\Title("删除销售报价")
     * @Apidoc\Desc("根据ID软删除销售报价，需管理员密码二次确认")
     * @Apidoc\Url("/admin/v1/sales/quotation/{id}")
