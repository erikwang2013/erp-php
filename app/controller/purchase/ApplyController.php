...
class ApplyController extends BaseController
{
     ...
     * @Apidoc\Author("erik")
     * @Apidoc\Tag("采购管理")
     * @Apidoc\Param(name="name", type="string", default="", desc="申请名称（必填）")
     * @Apidoc\Param(name="code", type="string", default="", desc="申请单号")
     * @Apidoc\Param(name="status", type="int", default=1, desc="状态")
     * @Apidoc\Returned("code", type="int", desc="业务代码,0=成功")
     * @Apidoc\Returned("message", type="string", desc="业务信息")
     * @Apidoc\Returned("data", type="object", desc="采购申请记录")
     */
     ...
     * @Apidoc\Author("erik")
     * @Apidoc\Tag("采购管理")
     * @Apidoc\Param(name="id", type="string", default="", desc="采购申请hashid")
     * @Apidoc\Returned("code", type="int", desc="业务代码,0=成功")
     * @Apidoc\Returned("message", type="string", desc="业务信息")
     * @Apidoc\Returned("data", type="object", desc="采购申请详情")
     */
     ...
     * @Apidoc\Tag("采购管理")
     * @Apidoc\Param(name="id", type="string", default="", desc="采购申请hashid")
     * @Apidoc\Param(name="name", type="string", default="", desc="申请名称")
     * @Apidoc\Param(name="code", type="string", default="", desc="申请单号")
     * @Apidoc\Param(name="status", type="int", default="", desc="状态")
     * @Apidoc\Returned("code", type="int", desc="业务代码,0=成功")
     * @Apidoc\Returned("message", type="string", desc="业务信息")
     * @Apidoc\Returned("data", type="object", desc="更新后的采购申请记录")
     */
